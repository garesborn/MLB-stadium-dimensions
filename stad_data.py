# -*- coding: utf-8 -*-
"""
Created on Wed Feb 17 16:48:42 2021
...
for i in teams:
    print(teams[i][0])
    code.append(i)
    name.append(teams[i][0])
    dis.append(teams[i][1])
    hei.append(teams[i][2])
    dform.append(teams[i][3])
    c1.append(teams[i][4])
    c2.append(teams[i][5])

data = {'team':code, 'stadium':name, 'distance':dis, 'height':hei, 'dform':dform, 'dcolor':c1, 'hcolor':c2}
